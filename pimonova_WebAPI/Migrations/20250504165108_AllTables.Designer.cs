...
namespace pimonova_WebAPI.Migrations
{
    ...
    [Migration("20250504165108_AllTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pimonova_WebAPI.Models.InstrumentalEmissionMeasuringOfSIZAV", b =>
                {
                    ...
                    b.ToTable("InstrumentalEmissionMeasuringsOfSIZAV");
                });

            modelBuilder.Entity("pimonova_WebAPI.Models.InstrumentalEmissionMeasuringOfSIZAV_Pollutant", b =>
                {
                    b.Property<int>("InstrumentalEmissionMeasuringOfSIZAVID")
                        .HasColumnType("integer")
                        .HasColumnOrder(0);
                    ...
                    b.HasKey("InstrumentalEmissionMeasuringOfSIZAVID", "PollutantCode");

                    b.HasIndex("PollutantCode");

                    b.ToTable("InstrumentalEmissionMeasuringsOfSIZAV_Pollutants");
                });
            ...
            modelBuilder.Entity("pimonova_WebAPI.Models.StationaryIZAV", b =>
                {
                    ...
                    b.Property<float>("OutputSpeedOfGIM")
                        .HasColumnType("real");

                    b.Property<int?>("SectorID")
                        .HasColumnType("integer");

                    b.Property<short>("TemperatureOfGIM")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("pimonova_WebAPI.Models.InstrumentalEmissionMeasuringOfSIZAV_Pollutant", b =>
                {
                    b.HasOne("pimonova_WebAPI.Models.InstrumentalEmissionMeasuringOfSIZAV", "InstrumentalEmissionMeasuringOfSIZAV")
                        .WithMany("InstrumentalEmissionMeasuringsOfSIZAV_Pollutants")
                        .HasForeignKey("InstrumentalEmissionMeasuringOfSIZAVID")
                    ...
                    b.Navigation("InstrumentalEmissionMeasuringOfSIZAV");
            ...
            modelBuilder.Entity("pimonova_WebAPI.Models.InstrumentalEmissionMeasuringOfSIZAV", b =>
                {
                    b.Navigation("InstrumentalEmissionMeasuringsOfSIZAV_Pollutants");
                });
